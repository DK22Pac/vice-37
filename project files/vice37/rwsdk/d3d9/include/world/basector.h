...
RWEXPORT RwPluginRegistry sectorTKList;
...
/* RWPUBLICEND */
/* Opening and closing */
RWEXPORT void* RWAPI _rpSectorOpen(void *instance, RwInt32 offset, RwInt32 size);
RWEXPORT void* RWAPI _rpSectorClose(void *instance, RwInt32 offset, RwInt32 size);

/* RWPUBLIC */

/* Instancing and deinstancing sectors */
RWEXPORT RpWorldSector* RWAPI RpWorldSectorRender(RpWorldSector *worldSector);

extern const RpWorldSector* RWAPI RpWorldSectorForAllMeshes(const RpWorldSector *sector,
...
RWEXPORT RwInt32 RWAPI RpWorldSectorGetNumTriangles(const RpWorldSector *Sector);
RWEXPORT RwInt32 RWAPI RpWorldSectorGetNumVertices(const RpWorldSector *Sector);

RWEXPORT const RwV3d* RWAPI
RpWorldSectorGetVertices(const RpWorldSector *sector);

RWEXPORT const RpTriangle* RWAPI
RpWorldSectorGetTriangles(const RpWorldSector *sector);

RWEXPORT const RwBBox* RWAPI RpWorldSectorGetBBox(const RpWorldSector *sector);
RWEXPORT const RwBBox* RWAPI RpWorldSectorGetTightBBox(const RpWorldSector *sector);

#endif /* (defined(RWDEBUG) || defined(RWSUPPRESSINLINE)) */

/* Plugins */
RWEXPORT RwInt32 RWAPI RpWorldSectorRegisterPlugin(RwInt32 size, RwUInt32 pluginID,
                                           RwPluginObjectConstructor constructCB,
                                           RwPluginObjectDestructor destructCB,
                                           RwPluginObjectCopy copyCB);
RWEXPORT RwInt32 RWAPI RpWorldSectorRegisterPluginStream(RwUInt32 pluginID,
                                                 RwPluginDataChunkReadCallBack readCB,
                                                 RwPluginDataChunkWriteCallBack writeCB,
                                                 RwPluginDataChunkGetSizeCallBack getSizeCB);
RWEXPORT RwInt32 RWAPI RpWorldSectorSetStreamAlwaysCallBack(
                    RwUInt32 pluginID,
                    RwPluginDataChunkAlwaysCallBack alwaysCB);
RWEXPORT RwInt32 RWAPI RpWorldSectorSetStreamRightsCallBack(RwUInt32 pluginID,
                                      RwPluginDataChunkRightsCallBack rightsCB);
RWEXPORT RwInt32 RWAPI RpWorldSectorGetPluginOffset(RwUInt32 pluginID);
RWEXPORT RwBool RWAPI RpWorldSectorValidatePlugins(const RpWorldSector *sector);
