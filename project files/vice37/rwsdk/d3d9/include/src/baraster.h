...
RWEXPORT void RWAPI RwRasterSetFreeListCreateParams( RwInt32 blockSize, RwInt32 numBlocksToPrealloc );

RWEXPORT RwRaster* RWAPI RwRasterCreate(RwInt32 width, RwInt32 height,
                                   RwInt32 depth, RwInt32 flags);
RWEXPORT RwBool RWAPI RwRasterDestroy(RwRaster * raster);

/* Pulling info out of raster structure */

#if (defined(RWDEBUG) || defined(RWSUPPRESSINLINE))
RWEXPORT RwInt32 RWAPI RwRasterGetWidth(const RwRaster *raster);
RWEXPORT RwInt32 RWAPI RwRasterGetHeight(const RwRaster *raster);
RWEXPORT RwInt32 RWAPI RwRasterGetStride(const RwRaster *raster);
RWEXPORT RwInt32 RWAPI RwRasterGetDepth(const RwRaster *raster);
RWEXPORT RwInt32 RWAPI RwRasterGetFormat(const RwRaster *raster);
RWEXPORT RwInt32 RWAPI RwRasterGetType(const RwRaster *raster);
RWEXPORT RwRaster* RWAPI RwRasterGetParent(const RwRaster *raster);
#endif /* (defined(RWDEBUG) || defined(RWSUPPRESSINLINE)) */

RWEXPORT RwRaster* RWAPI RwRasterGetOffset(RwRaster *raster, 
                                      RwInt16 *xOffset, RwInt16 *yOffset);

RWEXPORT RwInt32 RWAPI RwRasterGetNumLevels(RwRaster * raster);

RWEXPORT RwRaster* RWAPI RwRasterSubRaster(RwRaster * subRaster,
                                      RwRaster * raster, RwRect * rect);

RWEXPORT RwRaster* RWAPI RwRasterRenderFast(RwRaster * raster, RwInt32 x,
                                       RwInt32 y);
RWEXPORT RwRaster* RWAPI RwRasterRender(RwRaster * raster, RwInt32 x,
                                       RwInt32 y);
RWEXPORT RwRaster* RWAPI RwRasterRenderScaled(RwRaster * raster,
                                         RwRect * rect);

/* Raster rendering context */
RWEXPORT RwRaster* RWAPI RwRasterPushContext(RwRaster * raster);
RWEXPORT RwRaster* RWAPI RwRasterPopContext(void);
RWEXPORT RwRaster* RWAPI RwRasterGetCurrentContext(void);

/* Clearing rasters */
RWEXPORT RwBool RWAPI RwRasterClear(RwInt32 pixelValue);
RWEXPORT RwBool RWAPI RwRasterClearRect(RwRect * rpRect,
                                          RwInt32 pixelValue);

/* Displaying rasters */
RWEXPORT RwRaster* RWAPI RwRasterShowRaster(RwRaster * raster, void *dev,
                                       RwUInt32 flags);

/* Locking and releasing */
RWEXPORT RwUInt8* RWAPI RwRasterLock(RwRaster * raster, RwUInt8 level,
                                 RwInt32 lockMode);
RWEXPORT RwRaster* RWAPI RwRasterUnlock(RwRaster * raster);
RWEXPORT RwUInt8* RWAPI RwRasterLockPalette(RwRaster * raster,
                                        RwInt32 lockMode);
RWEXPORT RwRaster* RWAPI RwRasterUnlockPalette(RwRaster * raster);

/* Attaching toolkits */
RWEXPORT RwInt32 RWAPI RwRasterRegisterPlugin(RwInt32 size,
                                           RwUInt32 pluginID,
...
RWEXPORT RwInt32 RWAPI RwRasterGetPluginOffset(RwUInt32 pluginID);
RWEXPORT RwBool RWAPI RwRasterValidatePlugins(const RwRaster * raster);

/* RWPUBLICEND */

/* Opening and closing */
RWEXPORT void* RWAPI _rwRasterClose(void *instance, RwInt32 offset,
                                   RwInt32 size);
RWEXPORT void* RWAPI _rwRasterOpen(void *instance, RwInt32 offset,
                                      RwInt32 size);
