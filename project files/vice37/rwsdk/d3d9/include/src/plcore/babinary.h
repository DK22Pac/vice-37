...
/* Chunk header stuff */
RWEXPORT RwBool RWAPI RwStreamFindChunk(RwStream *stream, RwUInt32 type,
...
RWEXPORT RwStream* RWAPI _rwStreamWriteVersionedChunkHeader(RwStream *stream,
                                                   RwInt32 type,
                                                   RwInt32 size,
                                                   RwUInt32 version,
                                                   RwUInt32 buildNum);

RWEXPORT RwStream* RWAPI RwStreamWriteReal(RwStream *stream, const RwReal *reals,
                                   RwUInt32 numBytes);
RWEXPORT RwStream* RWAPI RwStreamWriteInt32(RwStream *stream, const RwInt32 *ints,
                                    RwUInt32 numBytes);
RWEXPORT RwStream* RWAPI RwStreamWriteInt16(RwStream *stream, const RwInt16 *ints,
                                    RwUInt32 numBytes);

RWEXPORT RwStream* RWAPI RwStreamReadReal(RwStream *stream, RwReal *reals,
                                  RwUInt32 numBytes);
RWEXPORT RwStream* RWAPI RwStreamReadInt32(RwStream *stream, RwInt32 *ints,
                                   RwUInt32 numBytes);
RWEXPORT RwStream* RWAPI RwStreamReadInt16(RwStream *stream, RwInt16 *ints,
                                   RwUInt32 numBytes);

/* Binary Portability Functions */
#if (defined(RWDEBUG) || defined(RWSUPPRESSINLINE) || defined(rwBIGENDIAN))
RWEXPORT void* RWAPI RwMemLittleEndian16(void *mem, RwUInt32 size);
RWEXPORT void* RWAPI RwMemLittleEndian32(void *mem, RwUInt32 size);
RWEXPORT void* RWAPI RwMemNative16(void *mem, RwUInt32 size);
RWEXPORT void* RWAPI RwMemNative32(void *mem, RwUInt32 size);
#endif /* (defined(RWDEBUG) || defined(RWSUPPRESSINLINE) || defined(rwBIGENDIAN)) */

#if (defined(RWFLOAT32FROMREAL))
RWEXPORT void* RWAPI RwMemRealToFloat32(void *mem, RwUInt32 size);
#endif /* (defined(RWFLOAT32FROMREAL)) */

#if (defined(RWREALFROMFLOAT32))
RWEXPORT void* RWAPI RwMemFloat32ToReal(void *mem, RwUInt32 size);
#else
#endif /* (defined(RWREALFROMFLOAT32)) */

RWEXPORT RwStream* RWAPI
RwStreamReadChunkHeaderInfo(RwStream *stream, RwChunkHeaderInfo *chunkHeaderInfo);

/* RWPUBLICEND */

RWEXPORT RwBool RWAPI _rwStreamReadChunkHeader(RwStream *stream, RwUInt32 *type,
