...
#if defined(_RWDLL)
__declspec(dllimport) RWEXPORT const RwChar   *_rwMemoryLastAllocFile;
__declspec(dllimport) RWEXPORT RwUInt32       _rwMemoryLastAllocLine;
#else /* defined(_RWDLL) */
RWEXPORT const RwChar *_rwMemoryLastAllocFile;
RWEXPORT RwUInt32     _rwMemoryLastAllocLine;
#endif /* defined(_RWDLL) */

RWEXPORT const RwChar* RWAPI
...
RWEXPORT RwMemoryFunctions* RWAPI RwOsGetMemoryInterface(void);
...
RWEXPORT RwFreeList* RWAPI RwFreeListCreate(RwInt32 entrySize,
                                     RwInt32 entriesPerBlock,
                                     RwInt32 alignment,
                                     RwUInt32 hint);
#endif /* (defined(RWDEBUG) && defined(RWFREELISTDBG) && !defined(DOXYGEN)) */
...
RWEXPORT RwBool RWAPI RwFreeListDestroy(RwFreeList * freelist);

RWEXPORT void RWAPI RwFreeListSetFlags( RwFreeList *freeList, RwUInt32 flags );
RWEXPORT RwUInt32 RWAPI RwFreeListGetFlags( RwFreeList *freeList );

/* RWPUBLICEND */

RWEXPORT void* RWAPI _rwFreeListAllocReal(RwFreeList * freelist,
                                         RwUInt32 hint);
RWEXPORT RwFreeList* RWAPI _rwFreeListFreeReal(RwFreeList * freelist,
                                        void *pData);

/* RWPUBLIC */
/* Garbage collection/enumeration */
RWEXPORT RwInt32 RWAPI RwFreeListPurge(RwFreeList * freelist);
RWEXPORT RwFreeList* RWAPI RwFreeListForAllUsed(RwFreeList * freelist,
                                         RwFreeListCallBack
                                         fpCallBack, void *pData);
RWEXPORT RwInt32 RWAPI RwFreeListPurgeAllFreeLists(void);

/* RWPUBLICEND */

/* Opening/Closing */
RWEXPORT void RWAPI _rwMemoryClose(void);
RWEXPORT RwBool RWAPI _rwMemoryOpen(const RwMemoryFunctions * memFuncs);
RWEXPORT void RWAPI _rwFreeListEnable(RwBool enabled);
