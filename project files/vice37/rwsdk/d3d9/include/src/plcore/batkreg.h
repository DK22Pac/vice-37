...
RWEXPORT const
RwPluginRegistry* RWAPI _rwPluginRegistryInitObject(const RwPluginRegistry * reg,
                                             void *object);
RWEXPORT const
RwPluginRegistry* RWAPI _rwPluginRegistryDeInitObject(const RwPluginRegistry * reg,
                                               void *object);
RWEXPORT const
RwPluginRegistry* RWAPI _rwPluginRegistryCopyObject(const RwPluginRegistry * reg,
                                             void *dstObject,
