...
RWEXPORT void* RWAPI _rwErrorOpen(void *object, RwInt32 offset, RwInt32 size);
RWEXPORT void* RWAPI _rwErrorClose(void *object, RwInt32 offset, RwInt32 size);

/* RWPUBLIC */
RWEXPORT RwError* RWAPI RwErrorGet(RwError *code);
RWEXPORT RwError* RWAPI RwErrorSet(RwError *code);
RWEXPORT RwInt32 RWAPI _rwerror(RwInt32 code, ...);
