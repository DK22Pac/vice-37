...
RWEXPORT void RWAPI RwRGBARealAdd(RwRGBAReal *result,
                          const RwRGBAReal *source1,
                          const RwRGBAReal *source2);

RWEXPORT void RWAPI RwRGBARealSub(RwRGBAReal *result,
                          const RwRGBAReal *source1,
                          const RwRGBAReal *source2);

RWEXPORT void RWAPI RwRGBARealScale(RwRGBAReal *result,
                            const RwRGBAReal *source,
                            RwReal scalar);

RWEXPORT void RWAPI RwRGBAFromRwRGBAReal(RwRGBA *result,
                                 const RwRGBAReal *source);

RWEXPORT void RWAPI RwRGBARealFromRwRGBA(RwRGBAReal *result,
                                 RwRGBA *source);
...
/* Init/Term */
RWEXPORT void* RWAPI _rwColorOpen(void *instance, RwInt32 offset, RwInt32 size);
RWEXPORT void* RWAPI _rwColorClose(void *instance, RwInt32 offset, RwInt32 size);
