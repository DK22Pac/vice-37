...
RWEXPORT RwUInt32 RWAPI RwEngineGetVersion(void);

/* Sequence of events to get RenderWare up and running */
RWEXPORT RwBool RWAPI RwEngineInit(const RwMemoryFunctions *memFuncs,
                           RwUInt32 initFlags,
                           RwUInt32 resArenaSize);
RWEXPORT RwInt32 RWAPI RwEngineRegisterPlugin(RwInt32 size, RwUInt32 pluginID,
                                  RwPluginObjectConstructor initCB,
                                  RwPluginObjectDestructor termCB);
RWEXPORT RwInt32 RWAPI RwEngineGetPluginOffset(RwUInt32 pluginID);
RWEXPORT RwBool RWAPI RwEngineOpen(RwEngineOpenParams *initParams);
RWEXPORT RwBool RWAPI RwEngineStart(void);
RWEXPORT RwBool RWAPI RwEngineStop(void);
RWEXPORT RwBool RWAPI RwEngineClose(void);
RWEXPORT RwBool RWAPI RwEngineTerm(void);

/* Finding out about the rendering sub systems available */
RWEXPORT RwInt32 RWAPI RwEngineGetNumSubSystems(void);
RWEXPORT RwSubSystemInfo* RWAPI RwEngineGetSubSystemInfo(RwSubSystemInfo *subSystemInfo, RwInt32 subSystemIndex);
RWEXPORT RwInt32 RWAPI RwEngineGetCurrentSubSystem(void);
RWEXPORT RwBool RWAPI RwEngineSetSubSystem(RwInt32 subSystemIndex);

/* Finding out about the modes available */
RWEXPORT RwInt32 RWAPI RwEngineGetNumVideoModes(void);
RWEXPORT RwVideoMode* RWAPI RwEngineGetVideoModeInfo(RwVideoMode *modeinfo, RwInt32 modeIndex);
RWEXPORT RwInt32 RWAPI RwEngineGetCurrentVideoMode(void);
RWEXPORT RwBool RWAPI RwEngineSetVideoMode(RwInt32 modeIndex);

/* Finding out how much texture memory is available */
RWEXPORT RwInt32 RWAPI RwEngineGetTextureMemorySize(void);
RWEXPORT RwInt32 RWAPI RwEngineGetMaxTextureSize(void);

/* Getting/Releasing the focus */
RWEXPORT RwBool RWAPI RwEngineSetFocus(RwBool enable);

/* Getting metrics */
RWEXPORT RwMetrics* RWAPI RwEngineGetMetrics(void);

/* RWPUBLICEND */

RWEXPORT RwBool RWAPI _rwDeviceSystemRequest(RwDevice *d, RwInt32 id, void *out,
                                 void *inOut, RwInt32 numIn);
RWEXPORT RwUInt32 RWAPI _rwGetNumEngineInstances(void);
 ...
 * of the system
 */
RWEXPORT RwDevice* RWAPI _rwDeviceGetHandle(void);
