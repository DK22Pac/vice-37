...
RWEXPORT RwBBox* RWAPI RwBBoxCalculate(RwBBox *boundBox,
                               const RwV3d *verts,
                               RwInt32 numVerts);
RWEXPORT RwBBox* RWAPI RwBBoxInitialize(RwBBox *boundBox,
                                const RwV3d *vertex);
RWEXPORT RwBBox* RWAPI RwBBoxAddPoint(RwBBox *boundBox,
                              const RwV3d *vertex);
RWEXPORT RwBool RWAPI RwBBoxContainsPoint(const RwBBox *boundBox,
                                  const RwV3d *vertex);
