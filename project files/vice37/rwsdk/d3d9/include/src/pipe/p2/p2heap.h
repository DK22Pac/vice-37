...
RWEXPORT RxHeap* RWAPI RxHeapCreate(RwUInt32 size);
RWEXPORT void RWAPI RxHeapDestroy(RxHeap * heap);
RWEXPORT RwBool RWAPI _rxHeapReset(RxHeap * heap);
RWEXPORT void* RWAPI RxHeapAlloc(RxHeap * heap, RwUInt32 size);
RWEXPORT void RWAPI RxHeapFree(RxHeap * heap, void *block);
RWEXPORT void* RWAPI RxHeapRealloc(RxHeap * heap, void *block,
