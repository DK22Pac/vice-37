...
RWEXPORT RwInt32 _rxPipelineMaxNodes;
RWEXPORT RwInt32 _rxHeapInitialSize;
...
RWEXPORT RxPacket* RWAPI
RxPacketCreate(RxPipelineNode * node);

RWEXPORT RxCluster* RWAPI
...
#if (defined(RWDEBUG))
RWEXPORT RxPacket* RWAPI RxPacketFetch(RxPipelineNode * Node);
RWEXPORT void RWAPI RxPacketDispatch(RxPacket * packet,
                                  RwUInt32 output,
                                  RxPipelineNode * self);
RWEXPORT void RWAPI RxPacketDispatchToPipeline(RxPacket * packet,
                                            RxPipeline * dest,
                                            RxPipelineNode * self);
...
RWEXPORT RxCluster* RWAPI RxClusterLockRead(RxPacket * packet, RwUInt32 clusterIndex);
...
RWEXPORT RxPipelineCluster* RWAPI
...
RWEXPORT RwBool RxPipelineInstanced;
...
RWEXPORT RxExecutionContext _rxExecCtxGlobal;
